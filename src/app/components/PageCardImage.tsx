...
const PageCardImage = ({post}: Props) => {
    ...
    return (
        <div className="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <Link href={`/blog/${slug}`}>
                {/* Utilizamos el Image de 'next/image'
                Debe tener las propiedades src, alt, width y height obligatoriamente
                Ademas hay que agregar una configuracion 'images' en el archivo 'next.config.js' */}
                <Image 
